-- ============================================================
-- Papillon – DROP EVERYTHING and rebuild clean
-- Safe to run: no real data exists
-- ============================================================
...
DROP FUNCTION IF EXISTS reserve_inventory(INTEGER, INTEGER);
DROP FUNCTION IF EXISTS release_reservation(INTEGER, INTEGER);
DROP FUNCTION IF EXISTS deduct_on_sale(INTEGER, INTEGER);
...
CREATE INDEX idx_payment_logs_merchant  ON payment_logs(merchant_transaction_id);

-- ── disable RLS (service_role key used server-side) ───────────
