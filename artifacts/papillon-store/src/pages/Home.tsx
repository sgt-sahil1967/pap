  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="bg-accent/30 py-20 px-4 text-center">
          <div className="container mx-auto max-w-4xl">
            ...
            <Link href="/collections">
              <Button size="lg" className="bg-secondary hover:bg-secondary/90 text-white font-bold text-lg px-8 rounded-full h-14">
                Shop the Collection
              </Button>
            </Link>
          </div>
